...
public class SmSWebService extends Service {
	...
	private final static QName SMSWEBSERVICE_QNAME = new QName(
			"http://tempuri.org/", "SmSWebService");
	...
	/**
	 *
	 * @return returns SmSWebServiceSoap
	 */
	...
	public SmSWebServiceSoap getSmSWebServiceSoap() {
		return super.getPort(new QName("http://tempuri.org/",
				"SmSWebServiceSoap"), SmSWebServiceSoap.class);
	}
	...
	public SmSWebServiceSoap getSmSWebServiceSoap(WebServiceFeature... features) {
		return super.getPort(new QName("http://tempuri.org/",
				"SmSWebServiceSoap"), SmSWebServiceSoap.class, features);
	}
