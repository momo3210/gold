...
public interface SmSWebServiceSoap {
	 ...
	 * @param content
	 * @param sendTime
	 * @return returns com.momohelp.calculate.webservice.WsSendResponse
	 */
	...
	public WsSendResponse sendSms(
			...
			@WebParam(name = "extno", targetNamespace = "http://tempuri.org/") String extno);
	 ...
	 * @param userid
	 * @param account
	 * @return returns com.momohelp.calculate.webservice.WsOverageResponse
	 */
	 ...
	 * @param account
	 * @param statusNum
	 * @return returns com.momohelp.calculate.webservice.WsStatusResponse
	 */
	...
	public WsStatusResponse queryStatus(
			...
			@WebParam(name = "account", targetNamespace = "http://tempuri.org/") String account,
			@WebParam(name = "password", targetNamespace = "http://tempuri.org/") String password,
			@WebParam(name = "statusNum", targetNamespace = "http://tempuri.org/") String statusNum);
	 ...
	 * @param userid
	 * @param account
	 * @return returns com.momohelp.calculate.webservice.WsCallResponse
	 */
	...
	public WsCallResponse queryCall(
			...
			@WebParam(name = "account", targetNamespace = "http://tempuri.org/") String account,
			@WebParam(name = "password", targetNamespace = "http://tempuri.org/") String password,
			@WebParam(name = "callNum", targetNamespace = "http://tempuri.org/") String callNum);
